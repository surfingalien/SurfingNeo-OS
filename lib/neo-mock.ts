...
export const graph: { nodes: GraphNode[]; links: GraphLink[] } = {
  nodes: [
    ...
    { id: 'site-2', label: 'PromptForge', type: 'site', status: 'degraded', size: 410, capacity: 88 },
...
export const platforms = [
  ...
  { id: 'graphify', name: 'Graphify', emoji: '⚙️', health: 99, latency: 24, status: 'healthy',
    endpoints: [{ path: '/graph/topology', method: 'GET', latency: 18, status: 200 }, { path: '/query', method: 'POST', latency: 32, status: 200 }, { path: '/metrics/summary', method: 'GET', latency: 41, status: 200 }] },
...
const flowMessages = [
  ...
  { platform: 'finsurfing', level: 'info', msg: 'ai-brain.scan 30-universe ok ({lat}ms)' },
  { platform: 'promptforge', level: 'ok', msg: 'scout.generate skill count=3 topic=research' },
  { platform: 'finsurfing', level: 'info', msg: 'copilot.stream SSE connected ({n} clients)' },
  { platform: 'promptforge', level: 'info', msg: 'council.decision advisors=5 topic=portfolio' },
];
